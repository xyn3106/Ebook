...
//	public static String IP = "112.74.205.86";
	public static String IP = "172.18.35.238";
	
	public static String HTTPURL = "http://"+IP+":8080/web/";
	public static String FOOD_IMG_URL = HTTPURL+"FoodImageTemp/";
