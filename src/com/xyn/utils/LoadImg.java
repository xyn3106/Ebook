...
public class LoadImg {
	private static String TAG = "LoadImg";
	//下载图片最大并行线程数
	...
	public Bitmap loadImage(final ImageView imageView,final String imageUrl,
		...
		//imageUrl由于其唯一型，把他作为map中的key
		//查找一级缓存（程序内部）,如果HashMap当中有这个key则直接读取然后返回这个图片
...
//			threadPools.execute(thread);//TODO
		}
