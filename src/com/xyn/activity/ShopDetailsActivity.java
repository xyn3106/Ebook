...
import com.xyn.source.ShopDetailsMore;
import com.xyn.utils.LoadImg;
import com.xyn.utils.MyJson;
import com.xyn.utils.MyJson.DetailCallBack;
...
public class ShopDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView();
		// 查找网络数据
		String endParames = Model.SHOPDETAILURL + "shopid=" + info.getfid();
						...
						public void getList(
							...
							if (ShopDetailsActivity.this.FoodList.size() > 0) {
								...
								for (int i = 0; i < FoodList.size(); i++) {
									foodtext += FoodList.get(i).getf_name()
											+ "  ";
								}
...
//		mShop_details_name.setText(info.getSname());TODO
...
//		mshop_details_phone_txt.setText(info.getStel());
		...
		int slevel = Integer.valueOf(info.getf_score());
		switch (slevel) {
		case 0:
