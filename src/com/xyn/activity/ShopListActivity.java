...
public class ShopListActivity extends Activity {
	...
	private void initView() {
		...
		initModel1();
		initModel2();
		oneadapter1 = new SearchMainAdapter(ShopListActivity.this, mainList1,R.layout.item_shop_list1,false);
		oneadapter1.setSelectItem(0);
		oneadapter2 = new SearchMainAdapter(ShopListActivity.this, mainList2,R.layout.item_shop_list1,true);
		oneadapter2.setSelectItem(0);
		topadapter = new SearchMoreAdapter(ShopListActivity.this,Model.SHOPLIST_TOPLIST,R.layout.item_shop_list2);
		threeadapter = new SearchMoreAdapter(ShopListActivity.this,Model.SHOPLIST_THREELIST,R.layout.item_shop_list2);
		...
		// -----------------------------------------------------------------
		mAdapter = new FoodAdapter(list, ShopListActivity.this);
...
//			startActivity(intent);
	...
	private void initAdapter1(String[] array) {
		twoadapter1 = new SearchMoreAdapter(ShopListActivity.this, array,R.layout.item_shop_list2);
		mShoplist_twolist1.setAdapter(twoadapter1);
		twoadapter1.notifyDataSetChanged();
	}

	private void initAdapter2(String[] array) {
		twoadapter2 = new SearchMoreAdapter(ShopListActivity.this, array,R.layout.item_shop_list2);
